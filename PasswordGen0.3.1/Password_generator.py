...
print('____________________________________________')
print('\n')
print('Este programa serve para criar uma senha com'
      ' caracteres aleátorios à sua escolha.')
print('\n')
print('Ao final do programa, as informações de login e senha são salvas'
      ' em um arquivo de texto.')
print('Ao fechar o programa, passe as informações para um local seguro')
print('\n')
...
while x == 1:
    ...
    ef = 1
    tipo = str(input("Qual o tipo de login? Gmail, Facebook, etc...: \n"))
    login = str(input("Quais o endereço de email do login?\n"))
    ...
    while e == False:
        ...
        if choice == 'Y' or choice == 'y' or choice == 'N' or choice == 'n':
            if choice == 'N' or choice == 'n':
                print('Não esqueça de passar as informações do arquivo de texto para um lugar seguro!!!!!\n')
                print('Este programa terá uma método para encriptar as informações no futuro,\nmas por hora, coloque as '
                      'informações '
                      'em um pen drive ou em núvem!\n')
